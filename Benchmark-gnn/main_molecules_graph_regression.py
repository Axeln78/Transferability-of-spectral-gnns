...
def main():
    ...
    root_log_dir = out_dir + 'logs/' + MODEL_NAME + "_" + DATASET_NAME + "_GPU" + str(
        config['gpu']['id'])+ "_" + params['seed'] + "_" + time.strftime('%Hh%Mm%Ss_on_%b_%d_%Y')
    ...
    write_file_name = out_dir + 'results/result_' + MODEL_NAME + "_" + DATASET_NAME + "_GPU" + str(
        config['gpu']['id'])+ "_" + params['seed'] + "_" + time.strftime('%Hh%Mm%Ss_on_%b_%d_%Y')
    write_config_file = out_dir + 'configs/config_' + MODEL_NAME + "_" + DATASET_NAME + "_GPU" + str(config['gpu']['id'])+ "_" + params['seed'] + "_" + time.strftime('%Hh%Mm%Ss_on_%b_%d_%Y')
